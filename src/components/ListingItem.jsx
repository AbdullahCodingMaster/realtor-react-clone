    ...
    <li className=" relative bg-white flex flex-col justify-between items-center shadow-md hover:shadow-xl rounded-md overflow-hidden transition duration-150 m-[10px]">
      <Link to={`/category/${listing.type}/${id}`} className="contents">
        <img
          ...
          //   alt={`${listing.name}`}
          alt=""
          className="h-[170px] w-full object-cover hover:scale-100 transition-scale duration-200 ease-in"
          loading="lazy"
        />
        <Moment
      ...
      {onDelete && (
        <FaTrash
          className="absolute bottom-2 right-2 text-red-500 h-[14px] cursor-pointer"
